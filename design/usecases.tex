...
The next chapters elaborate further on the specifications of the server and the client. In the \nameref{ch:server} chapter, the design choices behind the server model and methods are explained, and in the \nameref{ch:client} chapter on page~\pageref{ch:client} the user interface is shown and explained.
