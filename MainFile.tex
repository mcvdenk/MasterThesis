...
\part{Design Report}
    ...
    \input{./design/usecases.tex} %Done, to be reviewed by Tobias
    \input{./design/frameworks.tex} %Outlined
    \input{./design/server.tex} %Done, to be reviewed by Tobias
    \input{./design/client.tex} %Outlined
